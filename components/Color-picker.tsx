...
export default function ColorPicker() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#f7f6f5] dark:bg-gray-900">
      {/* Center the color picker card within the screen */}
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8 border-2 border-black">
